...
function index()
  ...
  -- web panel
  local webpanel = entry({ "webpanel" }, alias("webpanel", "go_to_homepage"), _("Seeeduino Cloud Web Panel"), 10)
  webpanel.sysauth = "root"
  webpanel.sysauth_authenticator = "arduinoauth"

  make_entry({ "webpanel", "homepage" }, call("homepage"), _("Seeeduino Cloud Web Panel"), 10)
